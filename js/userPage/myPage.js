// 카테고리
const $caBoard = $(".div-category[data-category='my-board']");
const $caScrap = $(".div-category[data-category='my-scrap']");
...
$(".li-category-wrap").on("click", function () {
    ...
    if (category === "my-board") {
        ...
        $caBoard.addClass("div-selected");
        $caScrap.removeClass("div-selected");
        ...
        $caScrap.addClass("div-selected");
        $caBoard.removeClass("div-selected");
